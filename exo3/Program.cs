...
namespace TableArticle
{
    class Program
    {
        ...
        {
            //Instanciation
            Article produitAuchan = new Article("t-shirt nike", 49, 253, TypeArticle.habillement);
            Article produitCarrefour = new Article("Playstation 5", 499, 58, TypeArticle.loisir);
            Article produitLidl = new Article("Croissant", 1, 30, TypeArticle.alimentaire);
